...
@Component({
  ...
  imports: [CommonModule, PanelModule, TableModule, DividerModule, ConfirmDialogModule,
    MarkdownModule,
    QuestStepsArrayPipe, UniverseDawnNumberFormatPipe, QuestGeneratorStepUpdateComponent, QuestGeneratorStepDialogUpdateComponent, QuestGeneratorStepRewardUpdateComponent],
...
export class QuestGeneratorStepComponent {
  ...
  moveStepUp(step: IQuestStep) {
    ...
    console.log(this.selectedQuest!.steps);
