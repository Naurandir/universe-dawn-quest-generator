...
import { EComponentType, ELocalisation, EReturnReward, ETaskType, IQuest, IQuestStep, IQuestSteps, IQuestTaskDialogue, IQuestTaskTransactCredits, IReturnRewardGiveLicense, IReturnRewardGiveResources, TQuestCondition, TQuestTask, TResources, TReturnReward } from './quest-ud.model';
